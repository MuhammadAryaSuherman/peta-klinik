      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl border border-border shadow-xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary/80 rounded-2xl flex items-center justify-center shadow-lg mb-4">
              <Building2 className="w-8 h-8 text-primary-foreground" />
            </div>
            <h1 className="text-2xl font-bold text-foreground">Masuk</h1>
            <p className="text-muted-foreground text-sm mt-1">Klinik BP3KP</p>
          </div>
